...
public class PotatoCycle : BaseCycle
{
    public override IEnumerator Cycle(GameObject weaponUser)
    {
        ...
        while(true)
        {
            ...
            Vector3 position = new Vector3(weaponUser.transform.position.x + -9.265f, weaponUser.transform.position.y + Random.Range(0.3f, cameraHeight + Camera.main.transform.position.y));
